...
export const industryCategoryMap: { [key: string]: string[] } = {
    "Marketing & Advertising": ["Digital Marketing Agency", "Traditional Advertising", "Public Relations", "Content Creation", "SEO/SEM Services"],
    "Retail": ["eCommerce (Online Stores)", "Physical Stores (Brick and Mortar Stores)", "Omnichannel (eCommerce and Physical Stores)"],
    "Education": ["K-12 School", "Higher Education", "EdTech Platform", "Coaching & Tutoring", "Corporate Training"],
    "Entertainment, Social Media & Gaming": ["Social Media Platform", "Gaming Studio", "Streaming Service", "Event Management", "Content Creator/Influencer"],
    ...
    "Real Estate & Construction": ["Real Estate Agency", "Construction Company", "Property Management", "Architecture & Planning", "Co-working Spaces"],
    "Restaurants": ["Fine Dining", "Quick Service Restaurant (QSR)", "Cafe & Bakery", "Food Delivery Service", "Catering"],
    "Manufacturing & IMPEX": ["Heavy Manufacturing", "Consumer Goods", "Electronics", "Import/Export Trading", "Logistics & Supply Chain"],
    "Fitness & Wellness": ["Gym & Fitness Center", "Yoga & Meditation Studio", "Wellness Retreats", "Nutrition & Dietetics", "Spa & Salon"]
};
