...
export const formTemplatesHtml: { [key: string]: string } = {
  ...
  'Book Vehicle': `
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Vehicle Bookings Form</title>
        <style>
            :root { --theme-color: #10b981; --theme-color-light: color-mix(in srgb, #10b981 10%, white); --theme-color-focus: color-mix(in srgb, #10b981 25%, transparent); --theme-color-dark: color-mix(in srgb, #10b981, black 10%); }
            body { font-family: 'Inter', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif; background-color: #f9fafb; color: #1f2937; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; }
            .form-wrapper { max-width: 42rem; margin: 3rem auto; padding: 1rem; }
    ...
    <body class="bg-gray-50">
        <div id="form-wrapper" class="form-wrapper">
            <div class="form-container">
                <h1 class="form-title">Vehicle Bookings Form</h1>
                <form id="wizard-form" novalidate>
                    
    <div class="progress-bar">
        <div class="progress-line" style="width: 0%;"></div>
        <div class="progress-step" data-step="0">1</div><div class="progress-step" data-step="1">2</div>
    </div>
                    
                    <div id="form-step-0" class="form-step" >
                        <h2 class="step-title">Customer Info</h2>
                        <h2 class="text-2xl font-bold text-gray-800 my-4">Vehicle Booking Form</h2>
    <p class="text-sm text-gray-500 my-2">Book your vehicle from here
    </p>
    <div class="form-field"><label for="full-name" class="form-label">Full Name<span class="text-red-500 ml-1">*</span></label><input type="text" id="full-name" name="full-name" class="form-input" required><div class="error-message" id="error-full-name" style="display: none;"></div></div>
    <div class="form-field"><label for="phone-number" class="form-label">Phone Number<span class="text-red-500 ml-1">*</span></label><input type="phone" id="phone-number" name="phone-number" class="form-input" required><div class="error-message" id="error-phone-number" style="display: none;"></div></div>
                    </div>
                

                    <div id="form-step-1" class="form-step" style="display: none;">
                        <h2 class="step-title">Booking Details</h2>
                        <div class="form-field"><label for="pickup-location" class="form-label">Pickup Location<span class="text-red-500 ml-1">*</span></label><input type="text" id="pickup-location" name="pickup-location" class="form-input" required><div class="error-message" id="error-pickup-location" style="display: none;"></div></div>
    <div class="form-field"><label for="drop-off-location" class="form-label">Drop-off Location<span class="text-red-500 ml-1">*</span></label><input type="text" id="drop-off-location" name="drop-off-location" class="form-input" required><div class="error-message" id="error-drop-off-location" style="display: none;"></div></div>
    <div class="form-field"><label for="pickup-date" class="form-label">Pickup Date<span class="text-red-500 ml-1">*</span></label><input type="date" id="pickup-date" name="pickup-date" class="form-input" required><div class="error-message" id="error-pickup-date" style="display: none;"></div></div>
    <div class="form-field"><label for="vehicle-type" class="form-label">Vehicle Type<span class="text-red-500 ml-1">*</span></label><select id="vehicle-type" name="vehicle-type" class="form-select" required><option value="">Select an option</option><option value="Mini Truck">Mini Truck</option><option value="Truck">Truck</option><option value="Van">Van</option><option value="Tempo">Tempo</option><option value="Others">Others</option></select><div class="error-message" id="error-vehicle-type" style="display: none;"></div></div>
