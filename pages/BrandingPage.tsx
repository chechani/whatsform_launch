...
const BrandingPage: React.FC<BrandingPageProps> = ({ navigate }) => {
    return (
        <main>
            <GenericPageHero 
            ...
            <div className="py-24 lg:py-28 bg-white dark:bg-slate-950">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-16">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-center text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">{brandingPageData.logo.description}</p>
