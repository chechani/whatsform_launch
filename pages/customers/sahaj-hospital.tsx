...
const SahajHospitalPage: React.FC = () => {
    return (
        <main>
            <GenericPageHero title={sahajHospitalPageData.hero.title} subtitle={sahajHospitalPageData.hero.subtitle} />
            
            <div className="py-16 lg:py-20 bg-white dark:bg-slate-950">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-20">
                    {sahajHospitalPageData.sections.map((section, index) => {
                        switch (section.type) {
                            case 'centeredText':
            ...
            <div className="bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-900 dark:to-slate-800 py-20">
                <div className="max-w-4xl mx-auto text-center px-6 sm:px-8 lg:px-12">
                    <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-6">
                        {sahajHospitalPageData.closing.title}
                    </h2>
                    <p className="text-xl text-slate-600 dark:text-slate-400 mb-8 max-w-3xl mx-auto">
                        {sahajHospitalPageData.closing.subtitle}
                    </p>
                    <Link 
                        href="/book-demo" 
