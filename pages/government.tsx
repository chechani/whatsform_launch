        ...
        <main>
            ...
            <div className="divide-y divide-slate-200/50 dark:divide-slate-800/50">
                {governmentPageData.sections.map((section, index) => {
                    const subCategory = governmentPageData.subCategories.find(sc => sc.id === (section as any).id);
                    return (
                                                ...
                                                <div>
                                                    ...
                                                    {subCategory && (
                                                        <div className="mt-8 text-center">
                                                            <Link href={`/public-utilities-non-profits/${subCategory.slug}`} legacyBehavior>
