...
import { ecommercePageData } from '../data/pages/ecommerce';
...
const EcommercePage: React.FC<EcommercePageProps> = ({ navigate }) => {
    return (
        <main>
            <GenericPageHero title={ecommercePageData.hero.title} subtitle={ecommercePageData.hero.subtitle} />
            <div className="divide-y divide-slate-200/50 dark:divide-slate-800/50">
                {ecommercePageData.sections.map((section, index) => (
            ...
            <div className="bg-pastel-green dark:bg-green-950/30 py-16 sm:py-20">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    <ContentSection title={ecommercePageData.closing.title} subtitle={ecommercePageData.closing.subtitle}>
