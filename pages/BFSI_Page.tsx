...
import { bfsiPageData } from '../data/pages/bfsi';

interface BFSI_PageProps {
...
const BFSI_Page: React.FC<BFSI_PageProps> = ({ navigate }) => {
    return (
        <main>
            ...
            <div className="bg-pastel-green dark:bg-green-950/30 py-16 sm:py-20">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    <ContentSection title={bfsiPageData.closing.title} subtitle={bfsiPageData.closing.subtitle}>
