...
import { smartyAiPageData } from '../data/pages/smartyAi';

interface SmartyAIPageProps {
...
const SmartyAIPage: React.FC<SmartyAIPageProps> = ({ navigate }) => {
    return (
        <main>
            <GenericPageHero title={smartyAiPageData.hero.title} subtitle={smartyAiPageData.hero.subtitle} />
            <div className="divide-y divide-slate-200/50 dark:divide-slate-800/50">
                {smartyAiPageData.sections.map((section, index) => (
            ...
            <div className="bg-slate-50 dark:bg-slate-900 py-16 sm:py-20 transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
