...
import { whatsappForPatientCareData as post } from '../../data/pages/blog/whatsappForPatientCare';
...
interface WhatsappForPatientCarePageProps {
    navigate: (path: string) => void;
}

const WhatsappForPatientCarePage: React.FC<WhatsappForPatientCarePageProps> = ({ navigate }) => {
    return (
        <main>
...
export default WhatsappForPatientCarePage;
