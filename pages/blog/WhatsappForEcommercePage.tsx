...
import { whatsappForEcommerceData as post } from '../../data/pages/blog/whatsappForEcommerce';
...
interface WhatsappForEcommercePageProps {
    navigate: (path: string) => void;
}

const WhatsappForEcommercePage: React.FC<WhatsappForEcommercePageProps> = ({ navigate }) => {
    return (
        <main>
...
export default WhatsappForEcommercePage;