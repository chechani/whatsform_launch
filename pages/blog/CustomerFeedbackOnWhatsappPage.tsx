...
import { customerFeedbackOnWhatsappData as post } from '../../data/pages/blog/customerFeedbackOnWhatsapp';
...
interface CustomerFeedbackOnWhatsappPageProps {
    navigate: (path: string) => void;
}

const CustomerFeedbackOnWhatsappPage: React.FC<CustomerFeedbackOnWhatsappPageProps> = ({ navigate }) => {
    return (
        <main>
...
export default CustomerFeedbackOnWhatsappPage;