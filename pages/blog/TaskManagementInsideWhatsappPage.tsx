...
import { taskManagementInsideWhatsappData as post } from '../../data/pages/blog/taskManagementInsideWhatsapp';
...
interface TaskManagementInsideWhatsappPageProps {
    navigate: (path: string) => void;
}

const TaskManagementInsideWhatsappPage: React.FC<TaskManagementInsideWhatsappPageProps> = ({ navigate }) => {
    return (
        <main>
...
export default TaskManagementInsideWhatsappPage;
