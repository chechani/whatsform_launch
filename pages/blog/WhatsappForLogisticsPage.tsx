...
import { whatsappForLogisticsData as post } from '../../data/pages/blog/whatsappForLogistics';
...
interface WhatsappForLogisticsPageProps {
    navigate: (path: string) => void;
}

const WhatsappForLogisticsPage: React.FC<WhatsappForLogisticsPageProps> = ({ navigate }) => {
    return (
        <main>
...
export default WhatsappForLogisticsPage;
