...
import { complianceRemindersOnWhatsappData as post } from '../../data/pages/blog/complianceRemindersOnWhatsapp';
...
interface ComplianceRemindersOnWhatsappPageProps {
    navigate: (path: string) => void;
}

const ComplianceRemindersOnWhatsappPage: React.FC<ComplianceRemindersOnWhatsappPageProps> = ({ navigate }) => {
    return (
        <main>
...
export default ComplianceRemindersOnWhatsappPage;
