...
import { eventRegistrationOnWhatsappData as post } from '../../data/pages/blog/eventRegistrationOnWhatsapp';
...
interface EventRegistrationOnWhatsappPageProps {
    navigate: (path: string) => void;
}

const EventRegistrationOnWhatsappPage: React.FC<EventRegistrationOnWhatsappPageProps> = ({ navigate }) => {
    return (
        <main>
...
export default EventRegistrationOnWhatsappPage;
