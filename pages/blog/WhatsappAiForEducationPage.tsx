...
import { whatsappAiForEducationData as post } from '../../data/pages/blog/whatsappAiForEducation';
...
interface WhatsappAiForEducationPageProps {
    navigate: (path: string) => void;
}

const WhatsappAiForEducationPage: React.FC<WhatsappAiForEducationPageProps> = ({ navigate }) => {
    return (
        <main>
...
export default WhatsappAiForEducationPage;
