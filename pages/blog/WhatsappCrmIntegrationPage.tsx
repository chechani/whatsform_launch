...
import { whatsappCrmIntegrationData as post } from '../../data/pages/blog/whatsappCrmIntegration';
...
interface WhatsappCrmIntegrationPageProps {
    navigate: (path: string) => void;
}

const WhatsappCrmIntegrationPage: React.FC<WhatsappCrmIntegrationPageProps> = ({ navigate }) => {
    return (
        <main>
...
export default WhatsappCrmIntegrationPage;
