...
import { governmentServicesOnWhatsappData as post } from '../../data/pages/blog/governmentServicesOnWhatsapp';
...
interface GovernmentServicesOnWhatsappPageProps {
    navigate: (path: string) => void;
}

const GovernmentServicesOnWhatsappPage: React.FC<GovernmentServicesOnWhatsappPageProps> = ({ navigate }) => {
    return (
        <main>
...
export default GovernmentServicesOnWhatsappPage;
