...
import { watiComparisonData } from '../data/pages/watiComparison';

const WatiComparisonPage: React.FC = () => {
    return (
        <main>
            <GenericPageHero 
                title={watiComparisonData.hero.title} 
                subtitle={watiComparisonData.hero.subtitle}
            />
                ...
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">
                            {watiComparisonData.comparison.title}
                        </h2>
                        <p className="text-xl text-slate-600 dark:text-slate-300 max-w-4xl mx-auto">
                            {watiComparisonData.comparison.subtitle}
                        </p>
                    </div>

                    <div className="space-y-16">
                        {watiComparisonData.comparison.features.map((category, categoryIndex) => (
                                            ...
                                            <div className="grid md:grid-cols-2 gap-8">
                                                <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-xl border border-red-200 dark:border-red-800">
                                                    <div className="flex items-center mb-4">
                                                        ...
                                                        <h5 className="font-semibold text-red-700 dark:text-red-300">Wati</h5>
                                                    </div>
            ...
            <section className="py-20 bg-green-50 dark:bg-green-900/20">
                <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">
                        {watiComparisonData.summary.title}
                    </h2>
                    <p className="text-xl text-slate-600 dark:text-slate-300 mb-8">
                        {watiComparisonData.summary.subtitle}
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/signup" legacyBehavior>
                            <a className="inline-flex items-center justify-center px-8 py-4 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl transition-colors duration-200 shadow-lg hover:shadow-xl">
                                {watiComparisonData.summary.cta}
                            </a>
                        </Link>
