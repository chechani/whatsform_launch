...
const TasksPage: React.FC<TasksPageProps> = ({ navigate }) => {
    return (
        <main>
            <GenericPageHero title={tasksPageData.hero.title} subtitle={tasksPageData.hero.subtitle} />
            <div className="divide-y divide-slate-200/50 dark:divide-slate-800/50">
                {tasksPageData.sections.map((section, index) => (
